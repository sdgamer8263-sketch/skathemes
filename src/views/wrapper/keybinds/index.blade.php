...
?>
  ...
  <a onclick="hideKeybinds()">
    <div id="skaKeybindsSiteOverlay" class="keybinds-site-overlay"></div>
  </a>
  <div id="skaKeybindsContainer" class="keybinds-container">
    <div class="keybinds-content-box">
      <div class="keybinds-content">
        ...
        @include('blueprint.extensions.skatheme.wrapper.keybinds.binds')
        @include('blueprint.extensions.skatheme.wrapper.keybinds.keys')
  ...
  <div id="skaKeybindsHideAlert" class="keybinds-close-alert">
