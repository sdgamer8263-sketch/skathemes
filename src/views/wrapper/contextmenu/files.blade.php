<!-- Files Context Menu -->
<div id="skaFilesContextMenu" class="context-container" style="width:unset;display:none">
  <div class="context-wrapper">
    <!-- Rename -->
    <button id="skaFilesContextButton" class="context-button">
    ...
    <!-- Move -->
    <button id="skaFilesContextButton2" class="context-button">
    ...
    <!-- Permissions -->
    <button id="skaFilesContextButton3" class="context-button">
    ...
    <!-- Duplicate (copy) -->
    <button id="skaFilesContextButton4" class="context-button">
      <svg xmlns="http://www.w3.org/2000/svg" class="context-icon" width="16" height="16" fill="currentColor" class="bi bi-copy" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1h1v1a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1v1z"/></svg>
      Duplicate
    </button><br>
    <!-- Archive -->
    <button id="skaFilesContextButton5" class="context-button">
    ...
    <!-- Unarchive -->
    <button id="skaFilesContextButton6" class="context-button">
      <svg xmlns="http://www.w3.org/2000/svg" class="context-icon" width="16" height="16" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16"><path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5zm13-3H1v2h14zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5"/></svg>
      Unarchive
    </button><br>
    <!-- Download -->
    <button id="skaFilesContextButton7" class="context-button">
    ...
    <!-- Restore -->
    <button id="skaFilesContextButton9" class="context-button">
    ...
    <!-- Lock -->
    <button id="skaFilesContextButton10" class="context-button">
    ...
    <!-- Unlock -->
    <button id="skaFilesContextButton11" class="context-button">
    ...
    <!-- Delete -->
    <button id="skaFilesContextButton8" class="context-button context-button-danger">
