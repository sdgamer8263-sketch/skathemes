...
<div id="skaContextMenu" class="context-container" style="width:unset;display:none">
  <div class="context-wrapper">
    <button id="skaContextButton" class="context-button">
    ...
    <button id="skaContextButton3" class="context-button">
    ...
    <button id="skaContextButton2" class="context-button">
