<style id="ska-mobile-navigation">
...
@if(Auth::check())
  <div class="ska-mobile-overlay" onclick="closeMobileNav()"></div>
  <div class="ska-mobile-nav">
  ...
  <script>
    ...
    function closeMobileNav() {
      ...
      let overlay = document.querySelector(".ska-mobile-overlay")
