@if(Auth::check())
<script>
  document.querySelector("head > meta[name='theme-color'][content='#0e4688']").setAttribute("content", "{{ $s_palette_dashboard_7 }}")
</script>
@endif
...
<style id="ska-theme">
  ...
  @if($s_statusgradient_style == "flat")
